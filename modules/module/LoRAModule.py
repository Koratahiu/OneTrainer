...
class OFTModule(PeftBase):
    ...
    def __init__(self, prefix: str, orig_module: nn.Module | None, oft_block_size: int, block_share: bool, oft_scaled: bool, use_matrix_exp: bool, oft_cans: bool, **kwargs):
        super().__init__(prefix, orig_module)
    ...
    def forward(self, x, *args, **kwargs):
        ...
        orth_rotate = self.oft_R._cayley_batch(
            effective_weight, self.oft_R.block_size, self.oft_R.use_cayley_neumann, self.oft_R.use_matrix_exp, self.oft_R.oft_cans
        )
